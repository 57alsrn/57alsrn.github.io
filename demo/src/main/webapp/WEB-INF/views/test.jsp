...
<div><c:if test="${id != null}">
  ...
  <form action="/testSubmit.do" method="post">
    <label for="tId">
     param 아이디 : <input id="tId" name="tId" type="text">
    </label>
    <br><br>
    <label for="tPwd">
     param 비밀번호 : <input id="tPwd" name="tPwd" type="text">
    </label>
    <label for="sId">
     http 아이디 : <input id="sId" name="sId" type="text">
    </label>
    <br><br>
    <label for="sPwd">
     http 비밀번호 : <input id="sPwd" name="sPwd" type="text">
    </label>
    <br><br>
  ...
  <div>
    넘어온 값 <br>
    requestParam 아이디 : ${param.sId} <br>
    requestParam 비밀번호 :${param.sPwd} <br>
    서블릿 아이디 : ${param.tId} <br>
    서블릿 비밀번호 : ${param.tPwd}
  </div>

  <button type="button" class="btn btn-light" onclick="location.href='/main.do'" >돌아가기</button>
